...
//    String g1 = "C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\jsonFiles\\g1.json";
    ...
    @Test
    void toJSONFileTest() {
        g1_json.toJSONFile("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\g1_output.json");
        JSON g1_OP_test = new JSON("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\g1_output.json");
        assertEquals(g1_json.graphObj.toString(), g1_OP_test.graphObj.toString());
        G1_json.toJSONFile("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\G1_output.json");
        JSON G1_OP_test = new JSON("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\G1_output.json");
        assertEquals(G1_json.graphObj.toString(), G1_OP_test.graphObj.toString());
        G2_json.toJSONFile("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\G2_output.json");
        JSON G2_OP_test = new JSON("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\G2_output.json");
        assertEquals(G2_json.graphObj.toString(), G2_OP_test.graphObj.toString());
        G3_json.toJSONFile("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\G3_output.json");
        JSON G3_OP_test = new JSON("C:\\Users\\roeyf\\OneDrive - Ariel University\\Matanel&Roey\\Ex2-OOP\\src\\OutputFiles\\G3_output.json");
